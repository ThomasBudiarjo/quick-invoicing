      ...
      <div className="mx-auto mt-4 max-w-[850px] px-4">
        ...
        >
          ...
          <div className="mt-6">
                    ...
                    <tr key={it.id} className="border-b border-border align-top">
                      <td className="px-2 py-2">
                        ...
                        <button
                          ...
                          className="no-print mt-0.5 text-xs font-medium"
                      ...
                      <td className="px-2 py-2 text-right font-medium">{fmtMoney(lineAmount(it), inv.currency, inv.numberFormat)}</td>
            ...
            <button onClick={addItem} className="no-print mt-2 text-sm font-medium" style={{ color: theme.accent }}>
              + Add line
            </button>
          </div>
